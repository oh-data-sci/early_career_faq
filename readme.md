...
1. **Career Pathways** ([answers](faq/1-career_pathways/questions.md))
2. **Skills and Tools** ([answers](faq/2-skills_and_tools/questions.md))
3. **Career Preparation** ([answers](faq/3-career_preparation/questions.md))
4. **Ethics and Responsibility** ([answers](faq/4-ethics_and_responsibility/questions.md))
5. **General Advice** ([answers](faq/5-general_advice_for_students/questions.md))
6. **Quick-Fire Round** ([answers](faq/6-quick_fire_round/questions.md))
...
## Career Preparation
  ...
  - "How do employers typically assess candidates in interviews for data roles, are there case studies, coding tasks, or presentations?"
