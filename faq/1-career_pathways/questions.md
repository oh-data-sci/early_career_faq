...
## A1. oskar holm, senior data scientist
myself, i came from physics. i did numerical astrophysics and cosmology at uni. as a bridge between observational and theoretical physics, i learned some skills that i found applicable to the. 
...
## A1. oskar holm, senior data scientist
i see it everywhere. any field that isn't undergoing growth in data-related roles is a field that saturated with a large number of data-related employee and natural churn will make plenty of roles available there as well. my recommendation to students and beginners is to take whatever it is you already know and love (be it healthcare, finance, sustainability, retail, manufacturing, government, or any other sector) and look into how data is used there, and how principled set up and use of data can improve operations in that field, then show you understand how how data helps, and that's how you will find a job, or the job will find you.
